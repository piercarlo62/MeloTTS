...
if __name__ == "__main__":
    ori_text = 'Questo servizio gratuito è"""" 【disponibile》 in cinese 【semplificato] e altre 123'
    print(ori_text)
    ...
    text = text_normalize(ori_text)
    print(text)
    phonemizer = MultiPhonemizer({"it": "espeak"})
    phoneme = phonemizer.phonemize(text, separator="", language='it')
    print(phoneme)
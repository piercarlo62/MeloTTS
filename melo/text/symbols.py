...
it_symbols = [
    ...
    "à", "è", "é", "ì", "í", "ò", "ó", "ù", "ú",
    "ɛ", "ɔ", "ʎ", "ɲ", "ʃ", "ts", "dz", "kw", "ɡw",
    "j", "w",
    "ˈ", "ː", "\u032a"
]
num_it_tones = 1

# Update the combine all symbols section
normal_symbols = sorted(set(zh_symbols + ja_symbols + en_symbols + kr_symbols + es_symbols + fr_symbols + de_symbols + ru_symbols + it_symbols))
symbols = [pad] + normal_symbols + pu_symbols
sil_phonemes_ids = [symbols.index(i) for i in pu_symbols]


# combine all tones
num_tones = num_zh_tones + num_ja_tones + num_en_tones + num_kr_tones + num_es_tones + num_fr_tones + num_de_tones + num_ru_tones + num_it_tones
